...
export class PasskeyNotSupportedError extends PasskeyError {
     ...
     */
    constructor(message = t(DEFAULT_LOCALE, 'errors.passkeyNotSupported', 'This browser does not support passkeys.')) {
        super(message);
...
export class UserCancelledError extends PasskeyError {
     ...
     */
    constructor(message = t(DEFAULT_LOCALE, 'errors.userCancelled', 'Passkey ceremony was cancelled by the user.')) {
        super(message);
